...
if(isset($_GET['codigo']) OR isset($_GET['carrera'])){           
    ...
    $sql = "SELECT * FROM docentes WHERE ci LIKE '%$codigo%' AND profesion LIKE '%$carrera%'";
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary " href="./docentes.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item dropdown" >
                    ...
                    <ul class="dropdown-menu" aria-labelledby="submenu1">
                        ...
                        <li><a  class="dropdown-item"  href="./notEstu.php">Ver Notas</a></li>
...
<div class="modal fade" id="registroModal" tabindex="-1" role="dialog" aria-labelledby="registroModalLabel" aria-hidden="true">
    ...
    <div class="col-md-2 mb-3"> <!-- Cambié "md-3" a "mb-3" para corregir la clase -->
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" id="celular" name="celular" required>
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <label for="correo" class="form-label">Profesion</label>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    botonEnviar.addEventListener("click", function() {
        ...
        if (nombre === '' || apellido === '' || ci === '' || celular === '' || correo === '' || profesion === '' || fechaNacimiento === '' || (!generoInput)) {
  ...
  <form action="" method="GET">
        ...
        <a class="btn btn-info" href="./reportes/reporDoc.php?codigo=<?php echo $codigo; ?>&carrera=<?php echo $carrera; ?>"target="_blank">Generar Reporte PDF</a>
    </form>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    ...
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Profesion</th>
                  ...
                  <tbody>
                      ...
                      <td>
                       ...
                       <td>
                       <h6 class="mb-0 text-sm"><?php echo $prof; ?></h6>
                      </td>
                      <td class="align-middle text-center text-sm">
                        
                        <a class="edit-btn  btn btn-info"  href='modDoc.php?id="<?php  echo $id; ?>"'><i class="material-icons text-sm">border_color</i></a>
