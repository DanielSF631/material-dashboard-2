  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main" >
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      ...
      <?php }?>
          ...
          ?>
           <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="subirnotas.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
         ...
         <li class="nav-item dropdown" >
           ...
           <li class="nav-item">
          <a class="nav-link text-white " href="cronogramas.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">domain</i>
            </div>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Subir Notas</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Materias Asignadas</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                       <h6 class="mb-0 text-sm"><?php echo $materia_nombre; ?></h6>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <button  class="ver-estudiantes btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-materia-id="<?php echo $materia_id; ?>"><i class="material-icons text-sm">add</i>Ver Estudiantes</button>
                      </td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      ...
      <div class="modal-body " id="estudiantes-list">
      ...
      <div class="modal-footer">
          ...
          function mostrarEstudiantes(materiaId) {
            $.ajax({
                ...
                success: function(response) {
                    $("#estudiantes-list").html(response);
        ...
        $(".ver-estudiantes").click(function() {
            var materiaId = $(this).data("materia-id");
            mostrarEstudiantes(materiaId);
        });
