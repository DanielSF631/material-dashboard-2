...
include("../php/bd.php");
   ...
   if(isset($_GET['codigo']) or isset($_GET['carrera'])){           
      ...
      $sql = "SELECT estudiantes.id_estudiante AS id, estudiantes.nombres AS nombres,estudiantes.apellidos AS apellidos, estudiantes.ci AS ci, carrera.nombre_carrera AS carrera_nombre
          FROM estudiantes
...
// Mostrar el mensaje en una alerta de JavaScript
if ($mensaje !== '') {
...
<div class="container">
    <h3>Registro de Estudiantes - Carreras</h3>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
            <div class="modal-header">
                <h5 class="modal-title" id="registroModalLabel">Registrar Estudiante - Carrera</h5>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" id="celular" name="celular" required>
          ...
          <div class="row">
            ...
            ?>
              <div class="col-md-4 mb-3">
                <label for="inputEmail" class="form-label">Carrera</label>
         ...
         <!-- Nuevos campos -->
                    <div class="row">
                      ...
                      <div class="col-md-8 mb-3">
                            ...
                            <input type="text" id="direccion" name="direccion" rows="3" required>
                        </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    botonEnviar.addEventListener("click", function() {
        ...
        if (nombre === '' || apellido === '' || ci === '' || celular === '' || correo === '' || carrera === '' || fechaNacimiento === '' || (!generoInput)) {
...
*/
  ...
  <form action="" method="GET">
        ...
        <a class="btn btn-info" href="./reportes/reporEstu.php?codigo=<?php echo $codigo; ?>&carrera=<?php echo $carrera; ?>"target="_blank">Generar Reporte PDF</a>
    </form>
