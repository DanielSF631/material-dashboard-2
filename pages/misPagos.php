...
comprobarInactividad();
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="./misPagos.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
   ...
   <h2>Mis Pagos</h2>
      <?php
       ...
       $idd=$_SESSION['id'];
                    ...
                    $sql = "SELECT p.id_pagos, p.fecha_pago, c.nombre_cuota, c.monto
                            FROM pagos AS p
                            INNER JOIN cuotas AS c ON p.id_cuota = c.id_cuota
                            WHERE p.id_estudiante = $idd";

                    $result = $conexion->query($sql);

                    if ($result->num_rows > 0) {

                        echo "<div  class='uk-margin-medium-top' property='text'>";
                        // Mostrar los resultados en una tabla HTML
                        echo "<table  class='uk-table uk-table-small uk-table-divider uk-table-responsive uk-text-small'>
                                <tr>
                                    <th style='text-align: center;'>Nro</th>
                                    <th style='text-align: center;'>Fecha de Pago</th>
                                    <th style='text-align: center;'>Nombre de Cuota</th>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td style='text-align: center;'>" . $row["nombre_cuota"] .' '.$cuota. "</td>
                                    <td style='text-align: center;'>" . $row["monto"] . "</td>
                                    <td style='text-align: center;'>" . $row["id_pagos"] . "</td>
                                  </tr>";
                                  $num++;
                        }
                        echo "</table>";
  ...
  table {
    ...
    margin: 0 auto; /* Centra la tabla en el centro de la página */
    border-collapse: separate; /* Separación de bordes de celdas */
