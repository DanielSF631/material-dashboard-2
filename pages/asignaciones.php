...
//$conexion = new mysqli('localhost', 'root', '', 'sisnotas');
              ...
              if ($resultado->num_rows > 0) {
                  while ($fila = $resultado->fetch_assoc()) {
                      echo "Carrera: " . $fila['nombre_carrera'] . "<br>";

                      // Obtener estudiantes por carrera
                      $id_carrera = $fila['id_carrera'];
                      $sql_estudiantes = "SELECT id_estudiante, nombres, apellidos FROM estudiantes WHERE id_carrera = $id_carrera";
                      ...
                      if ($resultado_estudiantes->num_rows > 0) {
                          while ($fila_estudiante = $resultado_estudiantes->fetch_assoc()) {
                              echo "Estudiante: " . $fila_estudiante['nombres'] . " " . $fila_estudiante['apellidos'] . "<br>";

                              // Mostrar las materias asignadas a este estudiante
                              ...
                              $sql_materias = "SELECT materias.nombre, horario.dia_semana, horario.hora_inicio, horario.hora_fin
                                  ...
                                  WHERE asigmateriaestu.id_estudiante = $id_estudiante";
                              ...
                              if ($resultado_materias->num_rows > 0) {
                                  while ($fila_materia = $resultado_materias->fetch_assoc()) {
                                      echo "Materia: " . $fila_materia['nombre'] . "<br>";
                                      echo "Día: " . $fila_materia['dia_semana'] . "<br>";
                                      echo "Hora inicio: " . $fila_materia['hora_inicio'] . "<br>";
                                      echo "Hora fin: " . $fila_materia['hora_fin'] . "<br>";
                                  }
                              } else {
                          ...
                          echo "No se encontraron estudiantes en esta carrera.";
                      }
