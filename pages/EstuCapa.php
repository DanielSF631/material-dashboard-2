...
include("../php/bd.php");
   ...
   if(isset($_GET['codigo']) or isset($_GET['carrera'])){           
      ...
      $sql = "SELECT estucapa.id_estucapa AS id, estucapa.nombres AS nombres,estucapa.apellidos AS apellidos, estucapa.ci AS ci, capacitacion.nombre AS carrera_nombre
          FROM estucapa
...
<div class="container">
    <h3>Registro de Estudiantes - Capacitacion</h3>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
            <div class="modal-header">
                <h5 class="modal-title" id="registroModalLabel">Registrar Estudiante - Capacitacion</h5>
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" id="celular" name="celular" required>
            ...
            <?php 
              ...
              $sql = "SELECT id_capacitacion, nombre FROM capacitacion";
              $result = $conexion->query($sql);
            ?>
              <div class="col-md-4 mb-3">
                <label for="inputEmail" class="form-label">Capacitacion</label>
                  <select   id="carrera" name="carrera" >
              <?php while ($row = $result->fetch_assoc()) { ?>
                  <option value="<?php echo $row['id_capacitacion']; ?>"><?php echo $row['nombre']; ?></option>
              <?php } ?>
                  </select>
                </div>
</div>
