    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
            <div class="modal-header">
                <h5 class="modal-title" id="registroModalLabel">Registrar Egreso</h5>
          ...
          <div class="col-md-6 mb-3">
                <label for="apellido" class="form-label">Concepto</label>
                <textarea  id="concepto" name="concepto" rows="8" cols="80"></textarea>
            </div>
