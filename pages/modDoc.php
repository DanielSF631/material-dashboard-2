...
<div class="container">
     ...
     <a class="edit-btn  btn btn-info"  href='docentes.php'><i class="material-icons text-sm">arrow_back</i>Volver</a>
</div>
<!-- Modal -->
    ...
    <div class="container-fluid py-4">
      <?php
        ...
        $consulta = "SELECT * FROM docentes WHERE id_docentes = $id";
        $resultado = mysqli_query($conexion, $consulta);
        $registro = mysqli_fetch_assoc($resultado);
        
        // Formulario de edición
        echo "<h2>Editar Registro</h2>";
        echo "<form method='post' action='mDoc.php'>";
        echo "<input type='hidden' name='id' value='" . $registro['id_docentes'] . "'>";
        echo "Nombre: <input type='text' name='nombre' class='form-control' value='" . $registro['nombres'] . "'>";
        echo "Apellido: <input type='text' class='form-control' name='apellido' value='" . $registro['apellidos'] . "'>";
        echo "CI: <input type='text' class='form-control' name='ci' value='" . $registro['ci'] . "'><br>";
