...
include("../php/bd.php");
 ...
 $sql = "SELECT cronograma.id_cronograma, cronograma.actividad,cronograma.fecha,materias.nombre
                                  FROM cronograma
                                  INNER JOIN materias ON cronograma.id_mat = materias.id_materia";
$resulta = $conexion->query($sql);

if (!$resulta) {
    echo "Error al obtener actividades: " . $conexion->error;
}
      ...
      $sql = "SELECT materias.nombre, materias.id_materia 
        FROM materias
        INNER JOIN asignarmateriadocente ON materias.id_materia = asignarmateriadocente.id_materia
        WHERE asignarmateriadocente.id_docente = $docente_id";
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link text-white " href="subirnotas.php">
           ...
           <li class="nav-item">
          <a class="nav-link text-white " href="./horariosDoc.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
         ...
         <li class="nav-item dropdown" >
           ...
           <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary " href="./pages/horariosDoc.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">domain</i>
            </div>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Mis Horarios</h6>
        </nav>
...
<div class="modal fade" id="registroModal" tabindex="-1" role="dialog" aria-labelledby="registroModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content ">
            <div class="modal-header">
                <h5 class="modal-title" id="registroModalLabel">Registrar Actividad</h5>
    ...
    <select name="materia" id="materia">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="ci" class="form-label">Fecha  </label>
                <input type="date" id="fecha" name="fecha" required>
            </div>
            <input type="text" id="idDoc" name="idDoc" style="display: none;" value="<?php echo $docente_id;?>">
...
<form method="get" action="./reportes/generarExcel.php"> <!-- Enviar el formulario a otro archivo PHP para generar el Excel -->
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Lista de Actividades</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    ...
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Actividad</th>
                  ...
                  <tbody>
                      ...
                      <td>
                       <h6 class="mb-0 text-sm"><?php echo $ap; ?></h6>
                      </td>
                       <td>
