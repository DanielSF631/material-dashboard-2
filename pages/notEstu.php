...
comprobarInactividad();
          ...
          <a class="nav-link text-white active bg-gradient-primary" href="./estudiantes.php">
           ...
           <li class="nav-item dropdown" >
                    ...
                    <ul class="dropdown-menu" aria-labelledby="submenu1">
                        <li><a class="dropdown-item" href="./pages/estudiantes.php">Registro/Inscripcion</a></li>
                        <li><a  class="dropdown-item"  href="./pages/notEstu.php">Notas</a></li>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Notas</h6>
        </nav>
    ...
    <!-- End Navbar -->
    <?php
// Consulta SQL para obtener los estudiantes y sus notas finales
$sql = "SELECT estudiantes.id_estudiante, estudiantes.nombres, estudiantes.apellidos, SUM(calificaciones.nota) AS nota_final
        FROM estudiantes
        INNER JOIN calificaciones ON estudiantes.id_estudiante = calificaciones.id_estudiante
        GROUP BY estudiantes.id_estudiante, estudiantes.nombres, estudiantes.apellidos";

$result = $conexion->query($sql);

if ($result->num_rows > 0) {
    echo "<table>";
    echo "<tr><th>ID</th><th>Nombre</th><th>Apellido</th><th>Nota Final</th><th>Resultado</th></tr>";
    while ($row = $result->fetch_assoc()) {
        $notaFinal = $row["nota_final"];
        $resultado = $notaFinal >= 60 ? "Aprobado" : "Reprobado";
        echo "<tr>";
