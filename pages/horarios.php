      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="./misPagos.php">
           ...
           <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary " href="./horarios.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <?php
       ...
       $idd=$_SESSION['id'];
                              ...
                              $sql_materias = "SELECT materias.nombre, horario.dia_semana, horario.hora_inicio, horario.hora_fin
                                  FROM materias
                                  INNER JOIN asigmateriaestu ON materias.id_materia = asigmateriaestu.id_materia
                                  INNER JOIN horario ON asigmateriaestu.id_horario = horario.id_horario
                                  WHERE asigmateriaestu.id_estudiante = $idd";
...
<?php
                                  ...
                                  echo "No se encontraron materias asignadas a este estudiante.";
                              }
