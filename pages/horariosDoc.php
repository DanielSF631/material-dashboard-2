        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link text-white " href="subirnotas.php">
           ...
           <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary " href="./horariosDoc.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
   ...
   <h2>Mis Horarios</h2>
      <?php
       ...
       $idd=$_SESSION['id'];
                              ...
                              $sql_materias = "SELECT materias.nombre, horario.dia_semana, horario.hora_inicio, horario.hora_fin
                                  FROM materias
                                  ...
                                  WHERE asignarmateriadocente.id_docente = $idd";
                              ...
                              if ($resultado_materias->num_rows > 0) {
                                  ...
                                  <form>
                                    <div class="form-group">
                                      ...
                                      <label for="nombre"><strong><?php echo $fila_materia['nombre']?></strong></label>
                                      
                                    </div>
                                    <div class="form-group">
                                      <label for="email">Dia:</label>
                                       <label for="nombre"><strong><?php echo $fila_materia['dia_semana']?></strong></label>
                                      
                                    </div>
                                    <div class="form-group">
                                      <label for="mensaje">Hora Inicio:</label>
                                       <label for="nombre"><strong><?php echo $fila_materia['hora_inicio']?></strong></label>
                                      
                                    </div>
                                      <div class="form-group">
                                      <label for="mensaje">Hora Fin:</label>
                                       <label for="nombre"><strong><?php echo $fila_materia['hora_fin']?></strong></label>
...
<?php
                                  ...
                                  echo "No se encontraron materias asignadas a este Docente.";
                              }
